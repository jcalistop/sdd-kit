...
**Ready** — Humano aprueba → cabecera y BACKLOG a Ready; confirmar dependencias.

**In Build** — Estado In Build; rama `feature/` o `bugfix/`; implementar según spec y perfil stack; quality gates en verde; **verificar arquitectura sana** (reference) antes de Validating.

**Validating** — PR con checklist core + stack; evidencia de tests; **auto-verificar DoD** (reference); pedir merge al humano.
