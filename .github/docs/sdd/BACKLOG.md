...
| ID      | Dominio  | Título | Versión | Spec |
| ------- | -------- | ------ | ------- | ---- |
| SDD-032 | docs     | Reestructurar README.md raíz (v1.3–v1.5 + rutas actuales) | patch | [spec](specs/docs/SDD-032-reestructurar-readme-raiz.md) |
