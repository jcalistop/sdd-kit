...
> **Reuso (SDD-026 / SDD-028):** para corridas nuevas, partir de [`core/guides/audits.md`](../../../../core/guides/audits.md) y la plantilla de **registro** (`core/templates/audit-registro-template.md`). En el modelo actual, un dogfood típico es **un solo registro** (no plan+informe dual). Este par histórico se conserva; no migrar.
...
- Metodología audits: [`core/guides/audits.md`](../../../../core/guides/audits.md) · stub [README.md](README.md)
