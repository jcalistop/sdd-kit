...
| ---------- | ------ | ------ | --------------------------------------------------------------------------------------------------- | --------------- | ------------------------------------------ |
| 2026-09-13 | v1.5.0 | v1.6.0 | archive SDD-024…033; dual-release; upgrade-guide § v1.6.0 (repo = kit, sin submodule)              | validate-sdd OK (0E) | Tag `v1.6.0` en `5d6253b` — campaña minor |
