...
| Artefacto         | Ruta                                        |
| ----------------- | ------------------------------------------- |
| Spec              | `.github/docs/sdd/specs/<dominio>/SDD-NNN-*.md` |
| BACKLOG           | `.github/docs/sdd/BACKLOG.md`                   |
| Config            | `.github/docs/sdd/sdd.config.yaml`              |
| Reglas de negocio | `.github/docs/sdd/../business/domain-rules.md`  |
| Ramas             | `.github/docs/sdd/branching.md`                 |
| Verificación      | `.cursor/rules/sdd-workflow-reference.mdc`  |
| Perfil stack      | `.cursor/rules/sdd-stack-sdd-kit.mdc`   |
...
3. Implementar alcance del spec; quality gates del perfil `sdd-kit`.
...
Ver `.github/docs/sdd/sdd.config.yaml` → `stack.quality_gates` y [reference.md](reference.md).
...
3. Arquitectura sana; `python ./cli/sdd.py validate`.
...
- `python ./cli/sdd.py prompt show build-spec --full`
