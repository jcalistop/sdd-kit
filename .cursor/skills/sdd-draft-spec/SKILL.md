...
| Artefacto          | Ruta                                             |
| ------------------ | ------------------------------------------------ |
| Instancia SDD      | `.github/docs/sdd/`                                  |
| Specs              | `.github/docs/sdd/specs/<dominio>/SDD-NNN-slug.md`   |
| Plantilla completa | `.github/docs/sdd/templates/spec-template.md`        |
| Plantilla simple   | `.github/docs/sdd/templates/spec-simple-template.md` |
| BACKLOG            | `.github/docs/sdd/BACKLOG.md`                        |
| Config / IDs       | `.github/docs/sdd/sdd.config.yaml`                   |
...
2. Asignar `SDD-NNN`; crear `.github/docs/sdd/specs/<dominio>/SDD-NNN-slug.md`.
...
2. `python ./cli/sdd.py validate` → 0 errores.
