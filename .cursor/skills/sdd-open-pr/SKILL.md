...
Abrir PR con checklist SDD hacia **`dev`**.
...
| Artefacto    | Ruta                               |
| ------------ | ---------------------------------- |
| Checklist PR | `.github/docs/sdd/checklist-pr.md`     |
| Plantilla PR | `.github/PULL_REQUEST_TEMPLATE.md` |
| Workflow     | `.github/docs/sdd/workflow.md`         |
...
4. `gh pr create` hacia **`dev`** (título `SDD-NNN: resumen`).
...
- `python ./cli/sdd.py prompt show open-pr --full`
